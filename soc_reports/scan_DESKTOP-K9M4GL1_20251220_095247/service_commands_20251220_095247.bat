...
REM Generated: 2025-12-20 09:52:48
...
REM INVESTIGATE suspicious service: Agent Activation Runtime_12e550
sc query "AarSvc_12e550"
wmic service where name="AarSvc_12e550" get *
Check file signature and location

REM INVESTIGATE suspicious service: GameDVR and Broadcast User Service_12e550
sc query "BcastDVRUserService_12e550"
wmic service where name="BcastDVRUserService_12e550" get *
Check file signature and location

REM INVESTIGATE suspicious service: Bluetooth User Support Service_12e550
sc query "BluetoothUserService_12e550"
wmic service where name="BluetoothUserService_12e550" get *
Check file signature and location

REM INVESTIGATE suspicious service: CaptureService_12e550
sc query "CaptureService_12e550"
wmic service where name="CaptureService_12e550" get *
Check file signature and location

REM INVESTIGATE suspicious service: Clipboard User Service_12e550
sc query "cbdhsvc_12e550"
wmic service where name="cbdhsvc_12e550" get *
Check file signature and location

REM INVESTIGATE suspicious service: Connected Devices Platform User Service_12e550
sc query "CDPUserSvc_12e550"
wmic service where name="CDPUserSvc_12e550" get *
Check file signature and location

REM INVESTIGATE suspicious service: Cloud Backup and Restore Service_12e550
sc query "CloudBackupRestoreSvc_12e550"
wmic service where name="CloudBackupRestoreSvc_12e550" get *
Check file signature and location

REM INVESTIGATE suspicious service: ConsentUX User Service_12e550
sc query "ConsentUxUserSvc_12e550"
wmic service where name="ConsentUxUserSvc_12e550" get *
Check file signature and location

REM INVESTIGATE suspicious service: CredentialEnrollmentManagerUserSvc_12e550
sc query "CredentialEnrollmentManagerUserSvc_12e550"
wmic service where name="CredentialEnrollmentManagerUserSvc_12e550" get *
Check file signature and location

REM INVESTIGATE suspicious service: DeviceAssociationBroker_12e550
sc query "DeviceAssociationBrokerSvc_12e550"
wmic service where name="DeviceAssociationBrokerSvc_12e550" get *
Check file signature and location

REM INVESTIGATE suspicious service: DevicePicker_12e550
sc query "DevicePickerUserSvc_12e550"
wmic service where name="DevicePickerUserSvc_12e550" get *
Check file signature and location

REM INVESTIGATE suspicious service: DevicesFlow_12e550
sc query "DevicesFlowUserSvc_12e550"
wmic service where name="DevicesFlowUserSvc_12e550" get *
Check file signature and location

REM INVESTIGATE suspicious service: MessagingService_12e550
sc query "MessagingService_12e550"
wmic service where name="MessagingService_12e550" get *
Check file signature and location

REM INVESTIGATE suspicious service: Now Playing Session Manager Service_12e550
sc query "NPSMSvc_12e550"
wmic service where name="NPSMSvc_12e550" get *
Check file signature and location

REM INVESTIGATE suspicious service: Sync Host_12e550
sc query "OneSyncSvc_12e550"
wmic service where name="OneSyncSvc_12e550" get *
Check file signature and location

REM INVESTIGATE suspicious service: P9RdrService_12e550
sc query "P9RdrService_12e550"
wmic service where name="P9RdrService_12e550" get *
Check file signature and location

REM INVESTIGATE suspicious service: PenService_12e550
sc query "PenService_12e550"
wmic service where name="PenService_12e550" get *
Check file signature and location

REM INVESTIGATE suspicious service: Contact Data_12e550
sc query "PimIndexMaintenanceSvc_12e550"
wmic service where name="PimIndexMaintenanceSvc_12e550" get *
Check file signature and location

REM INVESTIGATE suspicious service: PrintWorkflow_12e550
sc query "PrintWorkflowUserSvc_12e550"
wmic service where name="PrintWorkflowUserSvc_12e550" get *
Check file signature and location

REM INVESTIGATE suspicious service: Udk User Service_12e550
sc query "UdkUserSvc_12e550"
wmic service where name="UdkUserSvc_12e550" get *
Check file signature and location

REM INVESTIGATE suspicious service: User Data Storage_12e550
sc query "UnistoreSvc_12e550"
wmic service where name="UnistoreSvc_12e550" get *
Check file signature and location

REM INVESTIGATE suspicious service: User Data Access_12e550
sc query "UserDataSvc_12e550"
wmic service where name="UserDataSvc_12e550" get *
Check file signature and location

REM INVESTIGATE suspicious service: Web Threat Defense User Service_12e550
sc query "webthreatdefusersvc_12e550"
wmic service where name="webthreatdefusersvc_12e550" get *
Check file signature and location

REM INVESTIGATE suspicious service: Windows Push Notifications User Service_12e550
sc query "WpnUserService_12e550"
wmic service where name="WpnUserService_12e550" get *
Check file signature and location
