...
REM Generated: 2025-11-27 10:43:54
...
REM INVESTIGATE suspicious service: Agent Activation Runtime_12f79c
sc query "AarSvc_12f79c"
wmic service where name="AarSvc_12f79c" get *
Check file signature and location

REM INVESTIGATE suspicious service: GameDVR and Broadcast User Service_12f79c
sc query "BcastDVRUserService_12f79c"
wmic service where name="BcastDVRUserService_12f79c" get *
Check file signature and location

REM INVESTIGATE suspicious service: Bluetooth User Support Service_12f79c
sc query "BluetoothUserService_12f79c"
wmic service where name="BluetoothUserService_12f79c" get *
Check file signature and location

REM INVESTIGATE suspicious service: CaptureService_12f79c
sc query "CaptureService_12f79c"
wmic service where name="CaptureService_12f79c" get *
Check file signature and location

REM INVESTIGATE suspicious service: Clipboard User Service_12f79c
sc query "cbdhsvc_12f79c"
wmic service where name="cbdhsvc_12f79c" get *
Check file signature and location

REM INVESTIGATE suspicious service: Connected Devices Platform User Service_12f79c
sc query "CDPUserSvc_12f79c"
wmic service where name="CDPUserSvc_12f79c" get *
Check file signature and location

REM INVESTIGATE suspicious service: Cloud Backup and Restore Service_12f79c
sc query "CloudBackupRestoreSvc_12f79c"
wmic service where name="CloudBackupRestoreSvc_12f79c" get *
Check file signature and location

REM INVESTIGATE suspicious service: ConsentUX User Service_12f79c
sc query "ConsentUxUserSvc_12f79c"
wmic service where name="ConsentUxUserSvc_12f79c" get *
Check file signature and location

REM INVESTIGATE suspicious service: CredentialEnrollmentManagerUserSvc_12f79c
sc query "CredentialEnrollmentManagerUserSvc_12f79c"
wmic service where name="CredentialEnrollmentManagerUserSvc_12f79c" get *
Check file signature and location

REM INVESTIGATE suspicious service: DeviceAssociationBroker_12f79c
sc query "DeviceAssociationBrokerSvc_12f79c"
wmic service where name="DeviceAssociationBrokerSvc_12f79c" get *
Check file signature and location

REM INVESTIGATE suspicious service: DevicePicker_12f79c
sc query "DevicePickerUserSvc_12f79c"
wmic service where name="DevicePickerUserSvc_12f79c" get *
Check file signature and location

REM INVESTIGATE suspicious service: DevicesFlow_12f79c
sc query "DevicesFlowUserSvc_12f79c"
wmic service where name="DevicesFlowUserSvc_12f79c" get *
Check file signature and location

REM INVESTIGATE suspicious service: MessagingService_12f79c
sc query "MessagingService_12f79c"
wmic service where name="MessagingService_12f79c" get *
Check file signature and location

REM INVESTIGATE suspicious service: Now Playing Session Manager Service_12f79c
sc query "NPSMSvc_12f79c"
wmic service where name="NPSMSvc_12f79c" get *
Check file signature and location

REM INVESTIGATE suspicious service: Sync Host_12f79c
sc query "OneSyncSvc_12f79c"
wmic service where name="OneSyncSvc_12f79c" get *
Check file signature and location

REM INVESTIGATE suspicious service: P9RdrService_12f79c
sc query "P9RdrService_12f79c"
wmic service where name="P9RdrService_12f79c" get *
Check file signature and location

REM INVESTIGATE suspicious service: PenService_12f79c
sc query "PenService_12f79c"
wmic service where name="PenService_12f79c" get *
Check file signature and location

REM INVESTIGATE suspicious service: Contact Data_12f79c
sc query "PimIndexMaintenanceSvc_12f79c"
wmic service where name="PimIndexMaintenanceSvc_12f79c" get *
Check file signature and location

REM INVESTIGATE suspicious service: PrintWorkflow_12f79c
sc query "PrintWorkflowUserSvc_12f79c"
wmic service where name="PrintWorkflowUserSvc_12f79c" get *
Check file signature and location

REM INVESTIGATE suspicious service: Udk User Service_12f79c
sc query "UdkUserSvc_12f79c"
wmic service where name="UdkUserSvc_12f79c" get *
Check file signature and location

REM INVESTIGATE suspicious service: User Data Storage_12f79c
sc query "UnistoreSvc_12f79c"
wmic service where name="UnistoreSvc_12f79c" get *
Check file signature and location

REM INVESTIGATE suspicious service: User Data Access_12f79c
sc query "UserDataSvc_12f79c"
wmic service where name="UserDataSvc_12f79c" get *
Check file signature and location

REM INVESTIGATE suspicious service: Web Threat Defense User Service_12f79c
sc query "webthreatdefusersvc_12f79c"
wmic service where name="webthreatdefusersvc_12f79c" get *
Check file signature and location

REM INVESTIGATE suspicious service: Windows Push Notifications User Service_12f79c
sc query "WpnUserService_12f79c"
wmic service where name="WpnUserService_12f79c" get *
Check file signature and location
