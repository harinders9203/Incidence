...
REM Generated: 2026-01-03 15:10:12
...
REM INVESTIGATE suspicious service: Agent Activation Runtime_122ce8
sc query "AarSvc_122ce8"
wmic service where name="AarSvc_122ce8" get *
Check file signature and location

REM INVESTIGATE suspicious service: GameDVR and Broadcast User Service_122ce8
sc query "BcastDVRUserService_122ce8"
wmic service where name="BcastDVRUserService_122ce8" get *
Check file signature and location

REM INVESTIGATE suspicious service: Bluetooth User Support Service_122ce8
sc query "BluetoothUserService_122ce8"
wmic service where name="BluetoothUserService_122ce8" get *
Check file signature and location

REM INVESTIGATE suspicious service: CaptureService_122ce8
sc query "CaptureService_122ce8"
wmic service where name="CaptureService_122ce8" get *
Check file signature and location

REM INVESTIGATE suspicious service: Clipboard User Service_122ce8
sc query "cbdhsvc_122ce8"
wmic service where name="cbdhsvc_122ce8" get *
Check file signature and location

REM INVESTIGATE suspicious service: Connected Devices Platform User Service_122ce8
sc query "CDPUserSvc_122ce8"
wmic service where name="CDPUserSvc_122ce8" get *
Check file signature and location

REM INVESTIGATE suspicious service: Cloud Backup and Restore Service_122ce8
sc query "CloudBackupRestoreSvc_122ce8"
wmic service where name="CloudBackupRestoreSvc_122ce8" get *
Check file signature and location

REM INVESTIGATE suspicious service: ConsentUX User Service_122ce8
sc query "ConsentUxUserSvc_122ce8"
wmic service where name="ConsentUxUserSvc_122ce8" get *
Check file signature and location

REM INVESTIGATE suspicious service: CredentialEnrollmentManagerUserSvc_122ce8
sc query "CredentialEnrollmentManagerUserSvc_122ce8"
wmic service where name="CredentialEnrollmentManagerUserSvc_122ce8" get *
Check file signature and location

REM INVESTIGATE suspicious service: DeviceAssociationBroker_122ce8
sc query "DeviceAssociationBrokerSvc_122ce8"
wmic service where name="DeviceAssociationBrokerSvc_122ce8" get *
Check file signature and location

REM INVESTIGATE suspicious service: DevicePicker_122ce8
sc query "DevicePickerUserSvc_122ce8"
wmic service where name="DevicePickerUserSvc_122ce8" get *
Check file signature and location

REM INVESTIGATE suspicious service: DevicesFlow_122ce8
sc query "DevicesFlowUserSvc_122ce8"
wmic service where name="DevicesFlowUserSvc_122ce8" get *
Check file signature and location

REM INVESTIGATE suspicious service: MessagingService_122ce8
sc query "MessagingService_122ce8"
wmic service where name="MessagingService_122ce8" get *
Check file signature and location

REM INVESTIGATE suspicious service: Now Playing Session Manager Service_122ce8
sc query "NPSMSvc_122ce8"
wmic service where name="NPSMSvc_122ce8" get *
Check file signature and location

REM INVESTIGATE suspicious service: Sync Host_122ce8
sc query "OneSyncSvc_122ce8"
wmic service where name="OneSyncSvc_122ce8" get *
Check file signature and location

REM INVESTIGATE suspicious service: P9RdrService_122ce8
sc query "P9RdrService_122ce8"
wmic service where name="P9RdrService_122ce8" get *
Check file signature and location

REM INVESTIGATE suspicious service: PenService_122ce8
sc query "PenService_122ce8"
wmic service where name="PenService_122ce8" get *
Check file signature and location

REM INVESTIGATE suspicious service: Contact Data_122ce8
sc query "PimIndexMaintenanceSvc_122ce8"
wmic service where name="PimIndexMaintenanceSvc_122ce8" get *
Check file signature and location

REM INVESTIGATE suspicious service: PrintWorkflow_122ce8
sc query "PrintWorkflowUserSvc_122ce8"
wmic service where name="PrintWorkflowUserSvc_122ce8" get *
Check file signature and location

REM INVESTIGATE suspicious service: Udk User Service_122ce8
sc query "UdkUserSvc_122ce8"
wmic service where name="UdkUserSvc_122ce8" get *
Check file signature and location

REM INVESTIGATE suspicious service: User Data Storage_122ce8
sc query "UnistoreSvc_122ce8"
wmic service where name="UnistoreSvc_122ce8" get *
Check file signature and location

REM INVESTIGATE suspicious service: User Data Access_122ce8
sc query "UserDataSvc_122ce8"
wmic service where name="UserDataSvc_122ce8" get *
Check file signature and location

REM INVESTIGATE suspicious service: Web Threat Defense User Service_122ce8
sc query "webthreatdefusersvc_122ce8"
wmic service where name="webthreatdefusersvc_122ce8" get *
Check file signature and location

REM INVESTIGATE suspicious service: Windows Push Notifications User Service_122ce8
sc query "WpnUserService_122ce8"
wmic service where name="WpnUserService_122ce8" get *
Check file signature and location
