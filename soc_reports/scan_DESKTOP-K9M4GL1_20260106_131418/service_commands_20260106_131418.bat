...
REM Generated: 2026-01-06 13:14:19
...
REM INVESTIGATE suspicious service: Agent Activation Runtime_11910f
sc query "AarSvc_11910f"
wmic service where name="AarSvc_11910f" get *
Check file signature and location

REM INVESTIGATE suspicious service: GameDVR and Broadcast User Service_11910f
sc query "BcastDVRUserService_11910f"
wmic service where name="BcastDVRUserService_11910f" get *
Check file signature and location

REM INVESTIGATE suspicious service: Bluetooth User Support Service_11910f
sc query "BluetoothUserService_11910f"
wmic service where name="BluetoothUserService_11910f" get *
Check file signature and location

REM INVESTIGATE suspicious service: CaptureService_11910f
sc query "CaptureService_11910f"
wmic service where name="CaptureService_11910f" get *
Check file signature and location

REM INVESTIGATE suspicious service: Clipboard User Service_11910f
sc query "cbdhsvc_11910f"
wmic service where name="cbdhsvc_11910f" get *
Check file signature and location

REM INVESTIGATE suspicious service: Connected Devices Platform User Service_11910f
sc query "CDPUserSvc_11910f"
wmic service where name="CDPUserSvc_11910f" get *
Check file signature and location

REM INVESTIGATE suspicious service: Cloud Backup and Restore Service_11910f
sc query "CloudBackupRestoreSvc_11910f"
wmic service where name="CloudBackupRestoreSvc_11910f" get *
Check file signature and location

REM INVESTIGATE suspicious service: ConsentUX User Service_11910f
sc query "ConsentUxUserSvc_11910f"
wmic service where name="ConsentUxUserSvc_11910f" get *
Check file signature and location

REM INVESTIGATE suspicious service: CredentialEnrollmentManagerUserSvc_11910f
sc query "CredentialEnrollmentManagerUserSvc_11910f"
wmic service where name="CredentialEnrollmentManagerUserSvc_11910f" get *
Check file signature and location

REM INVESTIGATE suspicious service: DeviceAssociationBroker_11910f
sc query "DeviceAssociationBrokerSvc_11910f"
wmic service where name="DeviceAssociationBrokerSvc_11910f" get *
Check file signature and location

REM INVESTIGATE suspicious service: DevicePicker_11910f
sc query "DevicePickerUserSvc_11910f"
wmic service where name="DevicePickerUserSvc_11910f" get *
Check file signature and location

REM INVESTIGATE suspicious service: DevicesFlow_11910f
sc query "DevicesFlowUserSvc_11910f"
wmic service where name="DevicesFlowUserSvc_11910f" get *
Check file signature and location

REM INVESTIGATE suspicious service: MessagingService_11910f
sc query "MessagingService_11910f"
wmic service where name="MessagingService_11910f" get *
Check file signature and location

REM INVESTIGATE suspicious service: Now Playing Session Manager Service_11910f
sc query "NPSMSvc_11910f"
wmic service where name="NPSMSvc_11910f" get *
Check file signature and location

REM INVESTIGATE suspicious service: Sync Host_11910f
sc query "OneSyncSvc_11910f"
wmic service where name="OneSyncSvc_11910f" get *
Check file signature and location

REM INVESTIGATE suspicious service: P9RdrService_11910f
sc query "P9RdrService_11910f"
wmic service where name="P9RdrService_11910f" get *
Check file signature and location

REM INVESTIGATE suspicious service: PenService_11910f
sc query "PenService_11910f"
wmic service where name="PenService_11910f" get *
Check file signature and location

REM INVESTIGATE suspicious service: Contact Data_11910f
sc query "PimIndexMaintenanceSvc_11910f"
wmic service where name="PimIndexMaintenanceSvc_11910f" get *
Check file signature and location

REM INVESTIGATE suspicious service: PrintWorkflow_11910f
sc query "PrintWorkflowUserSvc_11910f"
wmic service where name="PrintWorkflowUserSvc_11910f" get *
Check file signature and location

REM INVESTIGATE suspicious service: Udk User Service_11910f
sc query "UdkUserSvc_11910f"
wmic service where name="UdkUserSvc_11910f" get *
Check file signature and location

REM INVESTIGATE suspicious service: User Data Storage_11910f
sc query "UnistoreSvc_11910f"
wmic service where name="UnistoreSvc_11910f" get *
Check file signature and location

REM INVESTIGATE suspicious service: User Data Access_11910f
sc query "UserDataSvc_11910f"
wmic service where name="UserDataSvc_11910f" get *
Check file signature and location

REM INVESTIGATE suspicious service: Web Threat Defense User Service_11910f
sc query "webthreatdefusersvc_11910f"
wmic service where name="webthreatdefusersvc_11910f" get *
Check file signature and location

REM INVESTIGATE suspicious service: Windows Push Notifications User Service_11910f
sc query "WpnUserService_11910f"
wmic service where name="WpnUserService_11910f" get *
Check file signature and location
